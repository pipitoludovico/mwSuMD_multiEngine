...
def SuMD_2_CV(par, selection_list, PARPATH):
    ...
    while c < max_cycles:
        ...
        walkers_metrics_1, walkers_metrics_2, allMetric_1, allMetric_2 = metricCompute(par, selection_list, n,
                                                                                       mothfolder)
        # compute scores and decide best walker
        scores_list, best_score = bestWalker_2metrics(par, walkers_metrics_1, walkers_metrics_2, allMetric_1,
                                                      allMetric_2)
        if scores_list == 0:
            continue
        # write log
